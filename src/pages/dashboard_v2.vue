    ...
    <div class="q-ma-md">
      ...
      <div class="row q-col-gutter-md">
        ...
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
          <q-card flat bordered class="shadow q-pa-none q-ma-none">
            <q-card-section class="row">
              <div :class="!$q.dark.isActive? 'text-grey-7':'text-white'" class="text-h6 col-12">Process Chart
      ...
      <div class="row q-col-gutter-md q-pt-md">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <q-card flat bordered class="shadow q-pa-none q-ma-none">
            <q-card-section>
              <div :class="!$q.dark.isActive? 'text-grey-7':'text-white'" class="text-h6">Resource Allocation (Headcount)
