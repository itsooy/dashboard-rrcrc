    ...
    <div class="row q-col-gutter-sm q-ma-xs q-mr-sm">
        ...
        <q-card>
          ...
          >
            ...
            <template v-slot:body-cell-kpi1="props">
              <q-td :props="props">
                <q-chip
                  :color="(props.row.kpi1 <= '3')?'red':(props.row.kpi1 > '3' && props.row.kpi1 <= '6')?'orange':(props.row.kpi1 > '6' && props.row.kpi1 <= '10')?'yellow-7':(props.row.kpi1 > '10' && props.row.kpi1 < '20')?'green':(props.row.kpi1 >= '20'?'blue':'grey-2')"
                  text-color="white"
                  dense
            ...
            <template v-slot:body-cell-kpi2="props">
              <q-td :props="props">
                <q-chip
                  :color="(props.row.kpi2 <= '3')?'red':(props.row.kpi2 > '3' && props.row.kpi2 <= '6')?'orange':(props.row.kpi2 > '6' && props.row.kpi2 <= '10')?'yellow-7':(props.row.kpi2 > '10' && props.row.kpi2 < '20')?'green':(props.row.kpi2 >= '20'?'blue':'grey-2')"
                  text-color="white"
                  dense
                  class="text-weight-bolder"
                  square
            ...
            <template v-slot:body-cell-kpi3="props">
              <q-td :props="props">
                <q-chip
                  :color="(props.row.kpi3 <= '15')?'red':(props.row.kpi3 > '15' && props.row.kpi3 <= '25')?'orange':(props.row.kpi3 > '25' && props.row.kpi3 <= '40')?'yellow-7':(props.row.kpi3 > '40' && props.row.kpi3 < '60')?'green':(props.row.kpi3 >= '60'?'blue':'grey-2')"
                  text-color="white"
                  dense
                  class="text-weight-bolder"
                  square
            ...
            <template v-slot:body-cell-kpi4="props">
              <q-td :props="props">
                <q-chip
                  :color="(props.row.kpi4 <= '3')?'red':(props.row.kpi4 > '3' && props.row.kpi4 <= '5')?'orange':(props.row.kpi4 > '5' && props.row.kpi4 <= '7')?'yellow-7':(props.row.kpi4 > '7' && props.row.kpi4 < '13')?'green':(props.row.kpi4 >= '13'?'blue':'grey-2')"
                  text-color="white"
                  dense
                  class="text-weight-bolder"
                  square
      ...
      <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
        ...
        <q-card flat bordered class="">
            ...
            <q-card-section>
              <IEcharts :option="gaugeOptions" ref="gauge" :resizable="true" style="height:320px"/>
            </q-card-section>
          </q-card>
      </div>
      <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
        <q-card flat bordered class="">
          ...
          <q-card-section>
            <IEcharts ref="pie" :option="pieOptions" :resizable="true" style="height:500px"/>
          </q-card-section>
        </q-card>
      </div>
            ...
            lineChartOption() {
                return {
                    ...
                    dataset: {
                        ...
                        source: [
                            //{months: 'January', kpi1: 0, kpi2: 0, kpi3: 0, kpi4: 0},
                            {months: 'January', kpi1: 16, kpi2: 5, kpi3: 31, kpi4: 9},
                            {months: 'February', kpi1: 16, kpi2: 7, kpi3: 42, kpi4: 8},
                            {months: 'March', },
                            {months: 'April', },
                            {months: 'May', },
                            {months: 'June', },
