    ...
    <div class="row q-col-gutter-sm q-ma-xs q-mr-sm">
        ...
        <q-card>
          ...
          >
            ...
            <template v-slot:body-cell-kpi1="props">
              <q-td :props="props">
                <q-chip
                  :color="(props.row.kpi1 <= '30')?'red':(props.row.kpi1 > '30' && props.row.kpi1 <= '40')?'orange':(props.row.kpi1 > '40' && props.row.kpi1 < '50')?'yellow-7':(props.row.kpi1 >= '50' && props.row.kpi1 < '70')?'green':(props.row.kpi1 >= '70'?'blue':'grey-2')"
                  text-color="white"
                  dense
            ...
            <template v-slot:body-cell-kpi2="props">
              <q-td :props="props">
                <q-chip
                  :color="(props.row.kpi2 <= '30')?'red':(props.row.kpi2 > '30' && props.row.kpi2 <= '70')?'orange':(props.row.kpi2 > '70' && props.row.kpi2 < '80')?'yellow-7':(props.row.kpi2 >= '80' && props.row.kpi2 < '100')?'green':(props.row.kpi2 >= '100'?'blue':'grey-2')"
                  text-color="white"
                  dense
                  class="text-weight-bolder"
                  square
            ...
            <template v-slot:body-cell-kpi3="props">
              <q-td :props="props">
                <q-chip
                  :color="(props.row.kpi3 <= '30')?'red':(props.row.kpi3 > '30' && props.row.kpi3 <= '40')?'orange':(props.row.kpi3 > '40' && props.row.kpi3 < '50')?'yellow-7':(props.row.kpi3 >= '50' && props.row.kpi3 < '70')?'green':(props.row.kpi3 >= '70'?'blue':'grey-2')"
                  text-color="white"
                  dense
                  class="text-weight-bolder"
                  square
            ...
            <template v-slot:body-cell-kpi4="props">
              <q-td :props="props">
                <q-chip
                  :color="(props.row.kpi4 <= '10')?'red':(props.row.kpi4 > '10' && props.row.kpi4 <= '20')?'orange':(props.row.kpi4 > '20' && props.row.kpi4 < '30')?'yellow-7':(props.row.kpi4 >= '30' && props.row.kpi4 < '50')?'green':(props.row.kpi4 >= '50'?'blue':'grey-2')"
                  text-color="white"
                  dense
                  class="text-weight-bolder"
                  square
                ...
                >{{props.row.kpi4}}
                <q-tooltip>
                  # Recepient Agencies/Families 
                </q-tooltip>  
                </q-chip>
              </q-td>
            </template>
            <template v-slot:body-cell-kpi5="props">
              <q-td :props="props">
                <q-chip
                  :color="(props.row.kpi5 <= '2')?'red':(props.row.kpi5 > '2' && props.row.kpi5 <= '3')?'orange':(props.row.kpi5 > '3' && props.row.kpi5 <= '5')?'yellow-7':(props.row.kpi5 > '5' && props.row.kpi3 < '10')?'green':(props.row.kpi5 >= '10'?'blue':'grey-2')"
                  text-color="white"
                  dense
                  class="text-weight-bolder"
                  square
            ...
            <template v-slot:body-cell-kpi6="props">
              <q-td :props="props">
                <q-chip
                  :color="(props.row.kpi6 <= '0')?'red':(props.row.kpi6 > '0' && props.row.kpi6 <= '1')?'orange':(props.row.kpi6 > '1' && props.row.kpi6 <= '2')?'yellow-7':(props.row.kpi6 > '2' && props.row.kpi6 < '5')?'green':(props.row.kpi6 >= '5'?'blue':'grey-2')"
                  text-color="white"
                  dense
                  class="text-weight-bolder"
                  square
          ...
          <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12" align="center" >
            <span style="font-size: 12px">Meaning of Colors: </span>
            <q-chip 
            square
            color="blue"
            text-color="white"
      ...
      <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
        <q-card flat bordered class="">
          <q-card-section style="height:170px">
            <q-img src="/statics/GIKlogoforTOP.png"></q-img>
          </q-card-section>
        </q-card>
        <q-card flat bordered class="">
      ...
      <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
        <q-card flat bordered class="">
          ...
          <q-separator inset></q-separator>
          <q-card-section>
            <IEcharts ref="pie" :option="pieOptions" :resizable="true" style="height:470px"/>
          </q-card-section>
        </q-card>
      </div> 
    </div>
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {name: 'kpi5', align: 'left', label: 'KPI 5', field: 'kpi5'},
                    {name: 'kpi6', align: 'left', label: 'KPI 6', field: 'kpi6'}
                ],
                data: [
                    {
                        name: 'January',
        ...
        computed: {
            ...
            lineChartOption() {
                return {
                    ...
                    dataset: {
                        dimensions: ['months', 'kpi1', 'kpi2', 'kpi3', 'kpi4', 'kpi5', 'kpi6'],
                        source: [
                            //{months: 'January', kpi1: 0, kpi2: 0, kpi3: 0, kpi4: 0, kpi5: 0, kpi6: 0},
                            {months: 'January', kpi1: 40, kpi2: 36, kpi3: 40, kpi4: 30, kpi5: 4, kpi6: 2},
                            {months: 'February', kpi1: 38, kpi2: 35, kpi3: 38, kpi4: 24, kpi5: 3, kpi6: 2},
                            {months: 'March', },
                            {months: 'April', },
                            {months: 'May', },
                            {months: 'June', },
                    ...
                    series: [
                        {
                            ...
                            data: [
                                ...
                                //{value: 3, name: 'Program supplies (Clothes Pin)', selected: false},
